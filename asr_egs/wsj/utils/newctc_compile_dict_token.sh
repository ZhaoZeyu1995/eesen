...
# Copyright 2021       Zeyu Zhao     (University of Edinburgh)
...
# This script compiles the lexicon and MMI-CTC (newctc) tokens into FSTs. FST compiling slightly differs between the
...
utils/token_table.py $dir/tokens.txt $space_char > $dir/tokens.table.txt # this is the real token 

mv $dir/tokens.table.txt $dir/tokens.txt

utils/newctc_token_fst.py $dir/tokens.txt | fstcompile --isymbols=$dir/tokens.txt --osymbols=$dir/tokens.txt \
